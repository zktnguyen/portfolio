...
const Footer = () => (
  <footer className='sticky-footer text-center'>
    ...
    <div className="text-muted">SIMPLE PORTFOLIO by KIM T NGUYEN 2017<br/>
      ...
      Created using <a href='https://reactjs.org/' rel='noopener noreferrer' target='_blank'>REACT.JS</a> and 
      <a href='http://getbootstrap.com/' rel='noopener noreferrer' target='_blank'> BOOTSTRAP 4 </a>
    </div>
  </footer>
